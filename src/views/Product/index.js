...
function Product(props) {
  ...
  const getFilteredProductsProduct = () =>{
      setFilteredProducts(
        products.filter((product) => product.product_name.toUpperCase().indexOf(searchBox.toUpperCase()) !== -1)
    );
  }
                ...
                <div className="card">
                    <div className="card-header">
                      ...
                      <div className='float-right'>
                          <input type="text" value={searchBox} onChange={(e) => setSearchBox(e.target.value)} name='searchBox' className="form-control" placeholder="Search product" />
                      </div>
                    </div>
                              ...
                              {filteredProducts.map((product,index) => (
                                <tr key={product.id}>
                                  ...
                                  <td>
                                    ...
                                    <button onClick={() => onDeleteHandler(product.product_id)} className="btn bg-danger btn-xs">
