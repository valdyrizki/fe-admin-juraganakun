      ...
      <section className="content">
        ...
        <div className="card">
          <div className="card-header">
            <h4 className="card-title">Jurnal Umum</h4>
            <br />
            <div className="row">
              <div className="form-group col-md-3">
                <div className="input-group">
                  ...
                  <input
                    ...
                    id="datepicker"
                    onChange={(e) => setStartDateJU(e.target.value)}
                  />
                </div>
              </div>
              ...
              <div className="form-group col-md-3">
                <div className="input-group">
                  ...
                  <input
                    ...
                    className="form-control float-right"
                    id="datepicker"
                    onChange={(e) => setEndDateJU(e.target.value)}
                  />
                </div>
              </div>
              <div className="form-group col-md-3">
                <div className="input-group">
                  <button className="btn btn-primary" onClick={doSearchTrx}>
                    Search
                  </button>
                </div>
              </div>
                ...
                <tbody>
                  ...
                  {journalTransactionJU.map((transaction, index) => (
                    <tr key={index}>
                      ...
                      <td>
                        {transaction.journal_account_id +
                          " - " +
                          transaction.journal_account.name}
                      </td>
        ...
        <div className="card">
          <div className="card-header">
            <h4 className="card-title">Buku Besar</h4>
            <br />
            <div className="row">
              <div className="form-group col-md-3">
                <div className="input-group">
                  ...
                  <select
                    onChange={(e) => getJournalAccountsByCategory(e)}
                    className="form-control form-control-sm"
                    id="journalCategoryBB"
                    name="journalCategoryBB"
                    placeholder="Category"
                    value={journalCategoryBB}
                  >
                    ...
                    {journalCategoriesBB.map((journalCategory) => (
                      <option
                        key={journalCategory.id}
                        value={journalCategory.id}
                      >{`${journalCategory.id} - ${journalCategory.name}`}</option>
                    ))}
                  </select>
                </div>
              </div>
              <div className="form-group col-md-3">
                <div className="input-group">
                  ...
                  <select
                    className="form-control form-control-sm"
                    id="journalAccountBB"
                    name="journalAccountBB"
                    placeholder="Category"
                    value={journalAccountBB}
                  >
                    <option value="DEFAULT">
                      -- Select Journal Account --
                    </option>
              ...
              <div className="form-group col-md-3">
                <div className="input-group">
                  ...
                  <input
                    type="date"
                    className="form-control float-right form-control-sm"
                    id="datepicker"
                    onChange={(e) => setStartDateJU(e.target.value)}
                  />
                </div>
                    ...
                    <div className="small-box bg-success">
                      ...
                      <div className="inner">
                        <h4>
                          ...
                          {decimalFormatter2(bank.balance)}
                        </h4>
                      </div>
                    </div>
                  </div>
